...
def main():
    parser = argparse.ArgumentParser(description="Generate metadata TSV from HAMAP .msa files.")
    parser.add_argument("input_folder", help="Path to folder containing .msa files")
